...
== OPTIONS
    ...
    Usage: annotate_models [options] [ModelName]*
        ...
        -s, --simple-indexes             Concat the column's related indexes in the annotation
            --model-dir dir              Annotate model files stored in dir rather than app/models, may be used multiple times
            --ignore-model-subdirects    Ignore subdirectories of the models directory
            --sort                       Sort columns in creation order rather than alphabetically
